...
public class PlayerBaseState : IState
{
    ...
    {
        if (HasParameter(animatorHash))
        {
            stateMachine.Player.animator.SetBool(animatorHash, true);
        }
        else
        {
            Debug.LogError($"Parameter hash '{animatorHash}' does not exist in the Animator.");
        }
    }
    ...
    {
        foreach (AnimatorControllerParameter param in stateMachine.Player.animator.parameters)
        {
